...
for farmer in json_data:
    ...
    for oneYear in range(0, len(yearly_emissions)):
        yearly_emissions[oneYear]["simulatedYield"]["displayYield"] = yearly_emissions[oneYear]["simulatedYield"]["displayYield"] + random.random()
        ...
        applied_configuration[oneYear]["farmerReportedYield"]["displayYield"] = yearly_emissions[oneYear]["simulatedYield"]["displayYield"] / 2
        applied_configuration[oneYear]["farmerReportedYield"]["displayUnit"] = yearly_emissions[oneYear]["simulatedYield"]["displayUnit"]


with open('/Users/smohar/Downloads/dyDouble_ExampleScope3Results.json', 'w+') as f:
